...
export const timeline: TimelineEntry[] = [
  {
    ...
    highlights: [
      "Developed and deployed the official Internship Portal for the Computer Engineering and Information Technology departments.",
      "Digitized internship objectives, weekly reports, evaluations, and faculty approval workflows.",
      "Built role-based modules for students, faculty mentors, and administrators.",
      "Engineered the platform using Flask, MySQL, Firebase, and modern web technologies.",
    ],
  },
  {
    date: "August 2025 – May 2026",
    location: "PCE Students' Council 2025–26",
    role: "Documentation Head",
    highlights: [
      "Selected as the Documentation Head for the PCE Students' Council 2025–26.",
      "Led documentation workflows and process standardization across council activities.",
      "Spearheaded development of the Council Website & Management Portal.",
  ...
  },
  {
    ...
    highlights: [
      "Selected as a Google Cloud Innovator.",
      "Completed 20+ Google Cloud Skill Badges across AI, Vertex AI, and cloud technologies.",
      "Built practical experience with Generative AI, machine learning, and cloud services.",
...
//  {
//    date: "2023",
//    location: "S.D.J School",
//    role: "AISSCE · Class XII",
//    highlights: ["94% aggregate."],
//  },
//  {
//    date: "2020",
//    location: "R.B.K School",
//    role: "CISCE · Class X",
//    highlights: ["95% aggregate."],
//  },
];

export const TRAJECTORY_START = "2024-09-01";
